...
void printUserIn(const UserIn_t *_u) {
    std::cout <<"ignition: " << static_cast<unsigned>(_u->ignition) << std::endl;
    std::cout <<"accelerator_pedal: " << static_cast<unsigned>(_u->accelerator_pedal) << std::endl;
    std::cout <<"brake_pedal: " << static_cast<unsigned>(_u->brake_pedal) << std::endl;
    std::cout <<"gear_position: " << static_cast<unsigned>(_u->gear_position) << std::endl;
    std::cout <<"end_simulation: " << static_cast<unsigned>(_u->end_simulation) << std::endl;
